...
let webAllTabs = require('./routes/api/tab/webAllTabs');
let webCreateTab = require('./routes/api/tab/webCreateTab');
...
let getGroupsUserIsIn = require('./routes/api/group/getGroupsUserIsIn')(passport);
...
app.use('/api/web/all-tabs', webAllTabs);
app.use('/api/web/create-tab', webCreateTab);
...
app.use('/api/get-groups-user-is-in', getGroupsUserIsIn);
